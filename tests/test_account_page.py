...
class TestAccountPage:
    ...
    def test_navigate_to_account_page_success(self, driver, set_user_tokens, create_user_and_order_and_delete):
    ...
    def test_logout_from_profile_page_success(self, driver, set_user_tokens, create_user_and_order_and_delete):
        main_page = MainPage(driver)
        account_page = AccountPage(driver)
        main_page.wait_for_the_personal_account_button_to_load()
        main_page.click_on_personal_account_in_header()
