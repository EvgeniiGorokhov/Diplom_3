...
class TestMainPage:
    ...
    def test_displaying_modal_window_details_of_ingredient_success(self, driver):
        main_page = MainPage(driver)
        main_page.wait_for_ingredients_to_load()
    ...
    def test_close_modal_window_details_of_ingredient_success(self, driver):
        ...
        main_page.wait_for_ingredients_to_load()
        main_page.click_on_ingredient()
        main_page.wait_for_the_X_button_to_load_closing_ingredient_details()
        main_page.click_on_the_X_button()
    ...
    def test_making_order_by_authenticated_user_success(self, driver, set_user_tokens, create_user_and_order_and_delete):
        main_page = MainPage(driver)
